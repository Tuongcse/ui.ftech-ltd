...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@/registry/ftech/ui/collapsible"
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
} from "@/registry/ftech/ui/resizable"
...
import {
  ...
  SidebarMenuSub,
  SidebarProvider,
} from "@/registry/ftech/ui/sidebar"
import { Tabs, TabsList, TabsTrigger } from "@/registry/ftech/ui/tabs"
import {
  ToggleGroup,
  ToggleGroupItem,
} from "@/registry/ftech/ui/toggle-group"
...
function BlockViewerProvider({
  ...
  const [style, setStyle] =
    React.useState<BlockViewerContext["style"]>("ftech")
      ...
      <div className="ml-auto hidden items-center gap-2 md:flex">
        ...
        <div className="flex h-7 items-center gap-1 rounded-md border p-[2px]">
          <Button
            ...
            size="sm"
            onClick={() => {
              copyToClipboard(`npx ftech-ui@latest add ${item.name}`)
            }}
          >
