...
export const Index: Record<string, any> = {
  ...
  "repository": {
    ...
    files: [{
      path: "registry/blocks/repository/data/[module]/index.ts",
      type: "registry:lib",
      target: "data/[module]/index.ts"
    },{
      path: "registry/blocks/repository/data/core/model.ts",
      type: "registry:lib",
      target: "data/core/model.ts"
    },{
      path: "registry/blocks/repository/data/core/net/api.ts",
      type: "registry:lib",
      target: "data/core/net/api.ts"
    },{
      path: "registry/blocks/repository/data/core/net/index.ts",
      type: "registry:lib",
      target: "data/core/net/index.ts"
    },{
      path: "registry/blocks/repository/data/index.ts",
      type: "registry:lib",
      target: "data/index.ts"
    },{
      path: "registry/blocks/repository/lib/helper.ts",
      type: "registry:lib",
      target: "lib/helper.ts"
    }],
    component: React.lazy(async () => {
      const mod = await import("@/registry/new-york-v4/blocks/repository/data/[module]/index.ts")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || item.name
      return { default: mod.default || mod[exportName] }
    }),
    meta: undefined,
  ...
  "products-01": {
    ...
    component: React.lazy(async () => {
      const mod = await import("@/registry/new-york-v4/blocks/products-01/page.tsx")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || item.name
      return { default: mod.default || mod[exportName] }
    }),
    meta: undefined,
